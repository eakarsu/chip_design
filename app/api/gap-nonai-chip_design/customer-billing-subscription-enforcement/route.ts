...
// Gap-nonai endpoint: Customer billing / subscription enforcement
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('customer-billing-subscription-enforcement', body, out);
    return NextResponse.json({ feature: 'customer-billing-subscription-enforcement', title: 'Customer billing / subscription enforcement', result: out });
