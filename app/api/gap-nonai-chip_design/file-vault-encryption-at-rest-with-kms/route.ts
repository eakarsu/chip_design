...
// Gap-nonai endpoint: File-vault encryption at rest with KMS
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('file-vault-encryption-at-rest-with-kms', body, out);
    return NextResponse.json({ feature: 'file-vault-encryption-at-rest-with-kms', title: 'File-vault encryption at rest with KMS', result: out });
